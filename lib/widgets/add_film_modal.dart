...
class AddFilmModal extends StatefulWidget {
  // Questa funzione passa il film scelto alla Dashboard
...
class _AddFilmModalState extends State<AddFilmModal> {
  ...
  Timer? _debounce; // Serve per non chiamare l'API ad ogni singola lettera digitata
  ...
  // --- LA FUNZIONE CHE CERCA SU TMDB IN TEMPO REALE ---
  void _cercaFilm(String query) {
    ...
    // Aspetta 500 millisecondi dopo che l'utente ha smesso di digitare
  ...
  Widget build(BuildContext context) {
    // Calcoliamo l'altezza in base allo schermo (vogliamo che copra circa il 70%)
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // I RISULTATI DELLA RICERCA (LA TENDINA)
          Expanded(
            child: _isSearching
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              ...
                              // AZIONE: QUANDO CLICCHI, SALVA IL FILM!
                              onTap: () {
                                final filmScelto = {
                                  'testo': film['title'], // 'testo' è come lo chiama il tuo server MySQL
                                  'copertina': posterPath != null ? 'https://image.tmdb.org/t/p/w500$posterPath' : null,
                                };
                                // Inviamo i dati alla Dashboard e chiudiamo la tendina
